...
g = ggplot(df2, aes(x=RDA1, y=RDA2)) + 
  ...
  geom_segment(data=df1, aes(x=0, xend=RDA1, y=0, yend=RDA2, 
               ...
               size = 1.5, alpha = 0.9) +
  scale_color_manual(values = c(brewer.pal(7, "YlGn"), 
                               "#8e8878", "#524640"), 
  ...
  geom_label(data=df1, 
             ...
             color = "black", size=4, 
             fill = c(brewer.pal(7, "YlGn")[1:5], 
                      "#8e8878", 
                      brewer.pal(7, "YlGn")[6:7], 
                      "#524640")) + 
...
ggsave("RedundancyCombined.pdf", plot = combi, 
       device = "pdf", dpi = 300, width = 8, height = 16, 
       units = "in")
ggsave("RedundancyCombined.tif", plot = combi, 
       device = "tiff", dpi = 300, width = 8, height = 10, 
       units = "in")
ggsave("RedundancyCombined.png", plot = combi, 
       device = "png", dpi = 600, width = 20, height = 26, 
       units = "cm")
