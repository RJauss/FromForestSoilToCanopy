...
```{r OomycotaRedundancyPlot, fig.width=9, fig.height=4, dpi=600}
...
```{r CercozoaRedundancyPlot, fig.height=4, fig.width=9, dpi=600}
...
```{r RedundancyAnalysisCombined, fig.width=8, fig.height=16, dpi=600}
g$labels$x = sub("\n", " - ", g$labels$x)
g$labels$y = sub("\n", " - ", g$labels$y)
