...
```{r Plot Barchart, fig.width=6.2,fig.height=6.2,dpi=300}
...
```{r Cercozoa, fig.width=6.2,fig.height=6.2,dpi=300}
...
```{r CombinedPlots, fig.width=6.2,fig.height=6.2,dpi=300}
...
```{r CombineWithIndicator, warning=FALSE}
